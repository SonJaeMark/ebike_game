...
class Obstacles:
    ...
    def pick_lane_and_initialize(self):
        ...
        # Position is safely based on the pre-shrunk current_size
    ...
    def load_image(self):
        ...
        if image_path:
            self.master_image = pygame.transform.scale(
        ...
        # FIX: Immediately shrink the image to its starting size so it never flashes at full size
